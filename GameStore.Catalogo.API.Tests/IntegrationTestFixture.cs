...
public class IntegrationTestFixture : IAsyncLifetime
{
    ...
    public CatalogoWebApplicationFactory Factory { get; private set; } = null!;
    ...
    {
        Factory = new CatalogoWebApplicationFactory(_testDatabaseName);
...
public class CatalogoIntegrationTests : IClassFixture<IntegrationTestFixture>
{
    private readonly IntegrationTestFixture _fixture;

    public CatalogoIntegrationTests(IntegrationTestFixture fixture)
    {
        _fixture = fixture;
    }
